    ...
    methods:{
      default_check(){
          if(this.pcm=="non-M1 Mac Pro 2019"){
            this.oss=['10.15.5','11.2.1','11.4','11.5','11.6','12.0.1','12.1','12.2','13.0']
            ...
            this.oss=['10.14.6','11.2.3']
            if(this.select_index===1){
              this.selected_os='11.2.3'
            }else{
              this.selected_os='10.14.6'
            }
          ...
          }else if(this.pcm=="M1 Mac Mini (2020)"){
            this.oss=['11.4','11.6','12.0.1','12.4','12.6','13.0']
            if(this.select_index===1){
              this.selected_os='11.6'
            }else if(this.select_index===2){
              this.selected_os='12.0.1'
          ...
          }else if(this.pcm=="M1 MacBook Air (2020)_1"){
            this.oss=['11.6','12.6.1','13.0']
            if(this.select_index===1){
              this.selected_os='11.6'
            }else if(this.select_index===2){
              this.selected_os='13.0'
            }else{
              this.selected_os='12.6.1'
            }
            ...
            this.oss=['10.15.7','11.5.2','12.4','12.5','13.0']
            if(this.select_index===1){
          ...
          }else if(this.pcm=="M1 MacBook Air (2020)_2"){
            ...
            this.oss=['12.5.1','13.0','13.1']
            if(this.select_index===1){
              this.selected_os='13.0'
            }else if(this.select_index===2){
              this.selected_os='13.1'
            }else{  
              this.selected_os='12.5.1'
            }
          }else if(this.pcm=="M1-Max Mac Studio"){
            this.oss=['12.3','12.5.1','13.0']
            if(this.select_index===1){
              this.selected_os='12.5.1'
            }else if(this.select_index===2){
              this.selected_os='13.0'
